...
vm.runInContext(read('library/frontier-systems-series.js'), sandbox, { filename: 'frontier-systems-series.js' });
...
if (components.length < 83) errors.push(`expected at least 83 components, found ${components.length}`);
requireUnique('id');
